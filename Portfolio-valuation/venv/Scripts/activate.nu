...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\abhishek.kumar\Web-Scrapping\Portfolio-valuation\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\abhishek.kumar\Web-Scrapping\Portfolio-valuation\venv\Scripts\deactivate.nu'
